...
describe("as 속성", () => {
  ...
  test.each([
    ...
    const { container } = render(<Flex as={as}>내용</Flex>);
...
describe("direction 속성", () => {
  test.each([
    { direction: "row", className: "flex-d_row" },
    { direction: "column", className: "flex-d_column" },
    { direction: "rowReverse", className: "flex-d_row-reverse" },
    { direction: "columnReverse", className: "flex-d_column-reverse" },
  ] as const)("direction=$direction일 때 $className 클래스가 적용됨", ({
    direction,
    className,
  }) => {
...
describe("align 속성", () => {
  test.each([
    ...
    render(<Flex align={align}>내용</Flex>);
...
describe("justify 속성", () => {
  test.each([
    ...
    render(<Flex justify={justify}>내용</Flex>);
...
describe("className 속성", () => {
  test("외부 className이 병합되어 적용됨", () => {
    render(<Flex className="custom-class">내용</Flex>);
