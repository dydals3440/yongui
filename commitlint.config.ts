  ...
  prompt: {
    ...
    questions: {
      type: {
        ...
        enum: {
          feat: { description: "신규 기능 추가", title: "Features" },
          fix: { description: "버그 수정", title: "Bug Fixes" },
          docs: {
            description: "문서 수정 (README, 문서 추가 등)",
            title: "Documentation",
          },
          style: {
      ...
      scope: {
        description: "스코프를 입력하세요 (예: root, ui, web, server 등)",
      },
      subject: {
      ...
      isBreaking: {
        description:
          "호환성을 깨뜨리는 변경사항인가요? (예: 버전 업그레이드, 코드 삭제 등)",
      },
      breakingBody: {
      ...
      issues: {
        description: "[NUGUL-num]에서 num에 해당하는 티켓 넘버를 작성해주세요!",
      },
    },
  },
};
